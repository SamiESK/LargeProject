...
function AccountInfo()
{
    ...
    const updatePassword = async (event) =>
    {
        ...
        var obj = { password: newpassword.value, repeat_password: newpassword2.value};
        var js = JSON.stringify(obj);
        ...
        try {
            ...
            if(res.error)
            {
                document.getElementById("passwordError").innerHTML = "Error : " + res.error;
            }
    ...
    <Container breakpoint="fluid" className="border p-10" id="accountPassword">
        <Content>
            ...
            <Row>
                ...
                <Col>
                    <input id="newpassword2"placeholder="Confirm New Password"></input>
                </Col>
                <br></br>
            ...
            <Col>   <Button onClick={updatePassword}color="primary">Submit</Button>
            </Col>
            </Row>
            <br></br>
    ...
    <Container breakpoint="fluid" className="border p-10" id="accountPassword">
        <Content>
            ...
            <Row>
                ...
                <Col>
                    <input id="deletepassword"placeholder="Enter Password"></input>
                </Col>
                <br></br>
            </Row>
            ...
            <Col>   <Button onClick={deleteAccount}color="danger">Delete</Button>
            </Col>
            </Row>
            <br></br>
